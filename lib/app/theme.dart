...
class AppTheme {
  static const Color cBg = Color(0xFF0C0D12);
  static const Color cSurface = Color(0xFF141720);
  static const Color cEdge = Color(0xFF1F2332);
  static const Color cAccent = Color(0xFF10B981);
  static const Color cAccent2 = Color(0xFF6EE7B7);
  static const Color cInk = Color(0xFFECFDF5);
